<?php
/* Smarty version 3.1.36, created on 2022-08-26 09:49:23
  from '/var/www/html/billing/modules/addons/vpnpanel/templates/servers.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63089723d59225_80387523',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '27abaead5eb7ae9504bfb39bd25083e8b2b2fb7c' => 
    array (
      0 => '/var/www/html/billing/modules/addons/vpnpanel/templates/servers.tpl',
      1 => 1661502792,
      2 => 'file',
    ),
  ),
...
function content_63089723d59225_80387523 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group control-group col-md-12">
                            ...
                            <div class="form-group control-group col-md-12">
                            <div class="controls input-group">
                                <label class="control-label input-group-addon" for="server_ipv4">Hostname</label>
                                <input class="form-control" id="server_ipv4" name="server_ipv4" placeholder="Eg. 10.0.0.08" data-fv-field="server_ipv4">
                            </div>
                            <small style="display: none;" class="help-block" data-fv-validator="notEmpty" data-fv-for="server_ip" data-fv-result="NOT_VALIDATED"></small></div>
                        <div class="form-group control-group col-md-12">
                            <div class="controls input-group">
...
modules/addons/vpnpanel/assets/flags/png/zimbabwe.png">zimbabwe</option></select>
                        ...
                        <div class="form-group control-group col-md-12">
                            <div class="controls input-group">
                                <label class="control-label input-group-addon" for="flag1">Status</label>
                                <select name="status" class="form-control serverstatus">
...
<p class="text-center">( If you enter the Server IP address, make sure you have configured the "<a href="https://www.smartersvpn.com/members/admin/addonmodules.php?module=vpnpanel&action=vpn_cfapi" target="_blank">CloudFlare API</a>", otherwise, you can go with hostname( fqdn) </p>
                </div>
                <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Close</button>
                    <!-- <button type="button" name="addserver" class="btn btn-default ml-2" id="addserverbtn1">Save as VPN Server <i class="fa fa-spin fa-spinner loading" style="display: none;"></i></button><i class="fa fa-info-circle"  data-toggle="tooltip" data-placement="top" title="That means you have already created as VPN server before, we are just adding it"></i> -->
                    <button type="button" name="addserver" class="btn btn-default ml-2" id="addserverbtn2">Save as Draft <i class="fa fa-spin fa-spinner loading" style="display: none;"></i> </button><i class="fa fa-info-circle"  data-toggle="tooltip" data-placement="top" title="That means if we have just saved it as VPS server, we will install / set up it later."></i>
                    <button type="button" name="createserver" class="btn btn-primary ml-2" id="createbtn">Save & Create VPN Server <i class="fa fa-spin fa-spinner loading" style="display: none;"></i> </button><i class="fa fa-info-circle"  data-toggle="tooltip" data-placement="top" title="We want to set up as VPN Server"></i>
...
<div class="modal fade" id="fixnowmodal" tabindex="-1" role="dialog" aria-labelledby="Fixnow" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="serverdetailspop">
            <div class="col-md-6">
            <div class="col-md-3 bandwidthusage" style="width: 25%; height: auto; max-width: 170px;"><p class="text-center" style="font-size: 14px; margin: 0px;">Bandwidth</p></div>
            <div class="col-md-3 cpu" style="width: 25%; height: auto; max-width: 170px;"><p class="text-center" style="font-size: 14px; margin: 0px;">CPU</p></div>
            <div class="col-md-3 memory" style="width: 25%; height: auto; max-width: 170px;"><p class="text-center" style="font-size: 14px; margin: 0px;">Memory</p></div>
            <div class="col-md-3 disk" style="width: 25%; height: auto; max-width: 170px;"><p class="text-center" style="font-size: 14px; margin: 0px;">Disk</p></div>
            </div>
            <div class="col-md-2">
            <p style="font-size: 14px; margin: 0px; margin-bottom: 15px;">Bandwidth (Live)</p>
            <div class=" upload" style="margin-bottom: 10px;"></div>
            <div class=" download" style="margin-bottom: 10px;"></div>
            </div>
            <div class="col-md-2">
            <p style="font-size: 14px; margin: 0px; margin-bottom: 15px;">Bandwidth (Allowed)</p>
            <div class=" upspeed" style="margin-bottom: 10px;"></div>
            <div class=" downspeed" style="margin-bottom: 10px;"></div>
            </div>
            <div class="col-md-2">
            <p style="font-size: 14px; margin: 0px; margin-bottom: 15px;">Other Info.</p>
            <div class=" uptime" style="margin-bottom: 10px;"></div>
            <div class=" lastupdated" style="margin-bottom: 10px;"></div>
            <div class=" total" style="margin-bottom: 10px;"></div>
            </div>
        </div>
...
.serverdetails p
{
    ...
    <link rel="stylesheet" href="../modules/addons/vpnpanel/templates/css/loading-bar.min.css">
<?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/popper.js@1.14.7/dist/umd/popper.min.js" crossorigin="anonymous"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../modules/addons/vpnpanel/templates/js/loading-bar.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
    function serverstatus(serverid)
    {
        if( $(document).find('.tr'+serverid+'').hasClass('tropen'))
        {
            $(document).find('.tr'+serverid+'').slideUp();
            $(document).find('#tr'+serverid+' .arrow').addClass('fa-caret-down');
            $(document).find('#tr'+serverid+' .arrow').removeClass('fa-caret-up');
            $(document).find('.tr'+serverid+'').removeClass('tropen');
        }
        else{
        $(document).find('.tr'+serverid+'').slideDown();
        $(document).find('.tr'+serverid+'').addClass('tropen');
        $(document).find('#tr'+serverid+' .arrow').addClass('fa-caret-up');
        $(document).find('#tr'+serverid+' .arrow').removeClass('fa-caret-down');
        $.ajax({
            url: '',
            type: 'POST',
            data: {
            ...
            success: function(data) {
                ...
                $cpu = ($resp.cpu != null)?$resp.cpu:'0';
                $disk = ($resp.disk != null)?$resp.disk:'0';
                $memory = ($resp.memory != null)?$resp.memory:'0';
                $uptime = ($resp.uptime != null)?$resp.uptime:'0 days';
                $lastupdated = ($resp.updated != null)?$resp.updated:"00:00";
                $upspeed = ($resp.upspeed != null)?$resp.upspeed:'0';
                $downspeed = ($resp.downspeed != null)?$.trim($resp.downspeed):'0';
                $total = ($resp.totald != null)?$resp.totald:'0';
                $upload = ($resp.upload != null)?$resp.upload:'0';
                $download = ($resp.download != null)?$resp.download:'0';
                $bandwidthusage = ($resp.bandwidthusage != null)?$resp.bandwidthusage:'0';
                $uploadVal = 0;
                $downloadVal = 0;

                $colorbandwidth = $colorcpu = $colormemory = $colordisk = '#2c3560';
                ...
                var bar1 = new ldBar(".serverdetailspop .bandwidthusage", {
                            "stroke": $colorbandwidth,
                            "stroke-width": 10,
                            "preset": "circle",
                            "value": Number(0)
                            });
                var bar2 = new ldBar(".serverdetailspop .cpu", {
                                    "stroke": $colorcpu,
                                    "stroke-width": 10,
                                    "preset": "circle",
                                    "value": Number(0)
                                    });
                var bar3 = new ldBar(".serverdetailspop .disk",{
                                    "stroke":  $colordisk,  
                                    "stroke-width": 10,
                                    "preset": "circle",
                                    "value": Number(0)
                                    });
                var bar4 = new ldBar(".serverdetailspop .memory", {
                                    "stroke":  $colormemory,  
                                    "stroke-width": 10,
                                    "preset": "circle",
                                    "value": Number(0)
                                    });
                bar1.set($bandwidthusage);
                bar2.set($cpu.replace('%',''));
                bar3.set($disk.replace('%',''));
                bar4.set($memory.replace('%',''));
                            $('.serverdetailspop .uptime').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Server Uptime: </p>'+$uptime);
                            $('.serverdetailspop .lastupdated').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Last Updated: </p>'+$lastupdated);
                            $('.serverdetailspop .download').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Download: </p>'+$download);
                            $('.serverdetailspop .upload').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Upload: </p>'+$upload);
                            // $('.serverdetailspop .total').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Data Transfered: </p>'+$total);
                            $('.serverdetailspop .downspeed').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Download: </p>'+$downspeed);
                            $('.serverdetailspop .upspeed').html('<p class="" style="font-size: 14px; float: left; margin: 0px;">Upload:  </p>'+$upspeed);
                var serverstatushtml = $('.serverdetailspop').html();
                $(document).find('.tr'+serverid+' td').html(serverstatushtml);
    ...
    var serverid = fixserverid;
                ...
                $.ajax({
                    ...
                    success: function (resultData) {
                        ...
                        $(document).find('#server_ipv4').val(data[0].server_ipv4);
    ...
    return false;
                        ...
                        if (data1.status == 'success')
                        {
                            ...
                            if (data1.data.length > 0)
                            {
                                $.each(data1.data, function (key, value) {
                                    ...
                                    {
                                        status1 = '<span class="badge badge-secondary" style="background: #ffa700;">Drafted</span>';
                                    }
            ...
            function addServer()
            {
                ...
                $.ajax({
                    type: "POST",
                    crossDomain: true,
                    data: {addserver: true, server_name: server_name, server_category: server_category, server_ip: server_ip, server_port: server_port, server_folder: server_folder, server_tcp: server_tcp, flag: flag,server_group:group},
                    dataType: "text",
                    success: function (resultData) {
                        $(document).find('.loading').hide();
                        if (resultData == 'success')
            ...
            function editServer()
            {
                ...
                $.ajax({
                    ...
                    success: function (resultData) {
                        ...
                        if(data[0].status == 3)
                        {
                            $(document).find('.serverstatus').attr('disabled', true);
                        }
                        else
                        {
                            $(document).find('.serverstatus').removeAttr('disabled');
                            $(document).find('.serverstatus').children('option').each(function(){
            ...
            function updateServer()
            {
                ...
                var status = $(document).find('.serverstatus').val();
                var server_ipv4 = $(document).find('#server_ipv4').val();
                var group = ''
                if(mainserver == 1)
                {
                    group = 'All';
                ...
                var datakeys = {updateServer: true, server_id: serverID, flag: flag, server_name: server_name, server_category: server_category, server_pass: server_pass, server_port: server_port,server_group:group, status: status, server_ipv4: server_ipv4};
                // var datakeys = {updateServer: true, server_id: serverID, flag: flag, server_name: server_name, server_category: server_category, server_pass: server_pass, server_port: server_port,server_group:group,maxcon:max_conn, status: status, server_ipv4: server_ipv4};
...
$('[data-toggle="tooltip"]').tooltip();
            ...
            $('#addserverbtn1').click(function(){
                swal({
                    ...
                    text: "Please confirm if you have \"client.ovpn\" file in the \"/root\" folder of this server",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: "btn-danger",
                ...
                $.ajax({
                    type: "POST",
                    crossDomain: true,
                    data: {addserver: true, mainserver: main_server, sshport: sshport, flag: flag, server_name: server_name, server_category: server_category, server_ip: server_ip, sshpass: sshpass,server_group:group},
                    dataType: "text",
                    success: function (resultData) {
...
return false;
            ...
            $('#addserverbtn2').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    crossDomain: true,
                    data: {saveserver: true, mainserver: main_server, sshport: sshport, flag: flag, server_name: server_name, server_category: server_category, server_ip: server_ip, sshpass: sshpass,server_group:group},
                    dataType: "text",
                    success: function (resultData) {
            ...
            $('#createbtn').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    crossDomain: true,
                    data: {createserver: true, mainserver: main_server, serverid: serverID, sshport: sshport, flag: flag, server_name: server_name, server_category: server_category, server_ip: server_ip, sshpass: sshpass,server_group:group},
                    dataType: "text",
                    success: function (resultData) {
