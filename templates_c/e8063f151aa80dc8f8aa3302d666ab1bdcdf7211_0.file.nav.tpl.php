<?php
/* Smarty version 3.1.36, created on 2020-10-28 05:06:16
  from '/var/www/html/whmcs/admin/templates/blend/nav.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f98fc4859bff8_90093069',
...
function content_5f98fc4859bff8_90093069 (Smarty_Internal_Template $_smarty_tpl) {
...
"<?php }?>>
        ...
        <li class="has-dropdown">
            <a id="Menu-Clients"<?php if (in_array("List Clients",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?> href="clients.php"<?php }?>>
...
">
        ...
        <li class="has-dropdown">
            <a id="Menu-Orders"<?php if (in_array("View Orders",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?> href="orders.php"<?php }?>>
        ...
        <li class="has-dropdown">
            <a id="Menu-Billing"<?php if (in_array("List Transactions",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?> href="transactions.php"<?php }?>>
        ...
        <li class="has-dropdown">
            <a id="Menu-Support"<?php if (in_array("Support Center Overview",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?> href="supportcenter.php"<?php }?>>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <?php if (in_array("View Reports",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>
            <li class="has-dropdown">
                <a id="Menu-Reports" href="reports.php">
...
"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['phpcompat'];?>
        ...
        <li class="has-dropdown">
            <a id="Menu-Addons" href="addonmodules.php">
...
">
        ...
        <?php }?>
        <li class="bt has-dropdown">
            <a id="Menu-Setup"href="<?php echo routePath('admin-setup-index');?>
" title="<?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['setup']['config'];?>
">
