    ...
    <tbody>
        ...
        {foreach from=$radclients item=radclient}
            <tr>
                ...
                <td>
                    <a href="{$modulelink}&action=vpn_userServices&userid={$radclient.userid}" class="showService btn btn-info" alt="View Services"> View Services</a>
                </td>
            </tr>
                    ...
                    <table class="table table-bordered table-striped datatable">
                        ...
                        <tbody>
                            ...
                            {foreach item=$clientService from=$radclient.services}
                                <tr>
                                    <td>
                                        <a href="clientsservices.php?userid={$radclient.userid}&id={$clientService->serviceid}" target="_blank">{$clientService->name} - {$clientService->groupname}</a>
                                    </td>
                                    ...
                                    <td>
                                         <div class="dropdown">
                                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">View Usage
