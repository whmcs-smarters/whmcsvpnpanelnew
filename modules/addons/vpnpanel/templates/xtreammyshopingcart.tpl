...
<script src="modules/addons/xtreamdashboard/templates/js/jquery.bootstrap-duallistbox.js"></script>

<script type="text/javascript" src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js"></script>
<script type="text/javascript" src="modules/addons/xtreamdashboard/templates/js/jquery.tablednd.js"></script>
<script src="modules/addons/xtreamdashboard/assets/js/tinymce/tinymce.min.js"></script>
                ...
                <div id="exTab2" class="container" style="width: 100%;">    
                    <ul class="nav nav-tabs">
                        ...
                        <li {if $sortprodctTab eq 'active'}class="active"{/if}>
                            <a  href="#6" data-toggle="tab">Sort Products</a>
                        </li>
                                    ...
                                    <div class="row" style="margin: 0px;">
                                        <div class="col-md-12">
                                            ...
                                            <form method="post">
                                                ...
                                                <p class="text-center" style="margin-top: 20px;"><button class="btn btn-primary" name="addProducts">Add Products</button></p>
                                            </form>
                                    ...
                                    <div class="row" style="margin: 0px;">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <form method="post" action="index.php?m=xtreamdashboard&action=xtreammyshopingcart">
                                                            ...
                                                            <td width="50%" valign="top">
                                                               ...
                                                               <table>
                                                                  <tbody>
                                                                     ...
                                                                     <tr>
                                                                        <td><a href="#" class="clickBtnIS" data-gettext="service_next_due_date">Next Due Date</a></td>
                                                                        <td>&#123;$service_next_due_date&#125;</td>
                                                                     </tr>
                                                                     <tr>
