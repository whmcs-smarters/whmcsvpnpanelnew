        ...
        <center style="margin-bottom: 20px;margin-top: 20px;">
            <form method="post" name="datepicker" action="{$modulelink}&action=vpn_usage&id={$service.serviceid}&m=d">
                <span style="font-size: 16px;color: #555;"><b>From:</b></span>
                    <input type="text" name="fromdate" value="{$service.fromdate}" size="10" class="date-picker" style="margin-right: 5px;">&nbsp;&nbsp;
                    <span style="font-size: 16px;color: #555;"><b>To:</b>
                        <input type="text" name="todate" value="{$service.todate}" size="10" class="date-picker" style="margin-right: 5px;">&nbsp;&nbsp;
                    ...
                    <input type="hidden" name="mode" value="dailyUsage">
