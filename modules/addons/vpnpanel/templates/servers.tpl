...
<div class="message" style="float: left; width: 100%;">{if $smarty.get.m eq 'success'}<p class="alert alert-success">Group Name Successfully saved.</p>{else if $smarty.get.m eq 'exist'}<p class="alert alert-warning">Group Name Already Exists.</p>{else if $smarty.get.m eq 'error'}<p class="alert alert-danger">Error Occoured.</p>{/if}</div>
                        ...
                        <div class="form-group control-group col-md-12 server_vpntype">
                            ...
                            <div class="controls input-group">
                                ...
                                <select class="form-control" id="server_group2" name="server_group" data-fv-field="server_group2">
                                   ...
                                   {foreach from=$serverGroups key="id" item="group"}
...
<script src="../modules/addons/vpnpanel/templates/js/loading-bar.min.js"></script>
    <script>
